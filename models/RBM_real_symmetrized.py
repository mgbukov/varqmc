...
# 	architecture=[W_fc_real, W_fc_imag,]
...
# 	# loss_log_psi=jnp.sum(log_psi)
# 	# loss_phase_psi=jnp.sum(phase_psi)	

# 	dlog_psi_s   = vmap(partial(grad(jit(loss_log_psi)),   NN_params))(batch, )
# 	dphase_psi_s = vmap(partial(grad(jit(loss_phase_psi)), NN_params))(batch, )
